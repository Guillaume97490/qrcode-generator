                    ...
                    <% if (data.type == "success"){ %>
                        <div class="col-lg-12 p-0 py-3 d-flex align-items-center">
                            <div class="row col-12">
                                <div data-id="<%= data.newUrl.slug%>" class="col-10 d-flex align-items-center text-break">
                                    <%= data.siteUrl%>item/<%= data.newUrl.slug%>
                                </div>
                                <div class="col-2 text-right">
                                    <button data-copy-id="<%= data.newUrl.slug%>" type="button" class="btn" data-toggle="tooltip" data-placement="top" title="Copier le lien">
                        ...
                        <div class="col-12 pb-2">
                            <a data-id="<%= data.newUrl.slug%>" class="btn btn-primary" href="">Génerer le Qr Code</a>
                        </div>
